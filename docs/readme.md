...
<ul>
   <li> Director instance. Refer to [Deploying BOSH Director](docs/deploy_director.md)<\li>
   <li> Bastion (need to install this separately?)<\li>
   <li> Manifest, development.yml and cloud-config<\li>
